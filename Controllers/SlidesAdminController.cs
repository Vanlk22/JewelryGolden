...
{
    public class SlidesAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Image,URL,DisplayOrder,Status")] Slide slide)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Image,URL,DisplayOrder,Status")] Slide slide)
        {
            if (ModelState.IsValid)
            {
